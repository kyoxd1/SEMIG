...
def loteryresp(request, question_id):
    try:
        ...
        if(question==123):
            ...
            return HttpResponseRedirect(reverse(urlRedirect, args=(1,sugesstion,respuestas,)))
            ...
            question_new = engine.question
            sugesstion = engine.sugesstion
            respuestas = 'Según sus respuestas a la \n Pregunta 1  ¿Conoce al Gorgojo de Los Andes?: '+question1+', Pregunta 2: '+question4+', y Pregunta 3:'+question5
            return HttpResponseRedirect(reverse(urlRedirect, args=(1,sugesstion,respuestas,)))
        elif(question == 146):
            question1 = request.POST['question1']
            question4 = request.POST['question4']
            ...
            question_new = engine.question
            sugesstion = engine.sugesstion
            respuestas = 'Según sus respuestas a la Pregunta 1  ¿Conoce al Gorgojo de Los Andes?: '+question1+', Pregunta 2: '+question4+', y Pregunta 3:'+question6
            return HttpResponseRedirect(reverse(urlRedirect, args=(1,sugesstion,respuestas,)))
        elif(question == 156):
            question1 = request.POST['question1']
            question5 = request.POST['question5']
            ...
            question_new = engine.question
            sugesstion = engine.sugesstion
            respuestas = 'Según sus respuestas a la Pregunta 1  ¿Conoce al Gorgojo de Los Andes?: '+question1+', Pregunta 2: '+question5+', y Pregunta 3:'+question6
            return HttpResponseRedirect(reverse(urlRedirect, args=(1,sugesstion,respuestas,)))
        elif(question == 234):
            question2 = request.POST['question2']
            question3 = request.POST['question3']
            ...
            urlRedirect = engine.urlRedirect
            sugesstion = engine.sugesstion
            respuestas = 'Según sus respuestas a la Pregunta 1 : '+question2+', Pregunta 2: '+question3+', y Pregunta 3:'+question4
            return HttpResponseRedirect(reverse(urlRedirect, args=(1,sugesstion,respuestas,)))
        elif(question == 235):
            question2 = request.POST['question2']
            question3 = request.POST['question3']
            ...
            question_new = engine.question
            sugesstion = engine.sugesstion
            respuestas = 'Según sus respuestas a la Pregunta 1 : '+question2+', Pregunta 2: '+question3+', y Pregunta 3:'+question5
            return HttpResponseRedirect(reverse(urlRedirect, args=(1,sugesstion,respuestas,)))
        elif(question == 236):
            question2 = request.POST['question2']
            question3 = request.POST['question3']
            ...
            question_new = engine.question
            sugesstion = engine.sugesstion
            respuestas = 'Según sus respuestas a la Pregunta 1 : '+question2+', Pregunta 2: '+question3+', y Pregunta 3:'+question6
            return HttpResponseRedirect(reverse(urlRedirect, args=(1,sugesstion,respuestas,)))
        elif(question == 245):
            question2 = request.POST['question2']
            question4 = request.POST['question4']
            ...
            question_new = engine.question
            sugesstion = engine.sugesstion
            respuestas = 'Según sus respuestas a la Pregunta 1 : '+question2+', Pregunta 2: '+question4+', y Pregunta 3:'+question6
            return HttpResponseRedirect(reverse(urlRedirect, args=(1,sugesstion,respuestas,)))
        elif(question == 256):
            question2 = request.POST['question2']
            question5 = request.POST['question5']
            ...
            question_new = engine.question
            sugesstion = engine.sugesstion
            respuestas = 'Según sus respuestas a la Pregunta 1 : '+question3+', Pregunta 2: '+question5+', y Pregunta 3:'+question6
            return HttpResponseRedirect(reverse(urlRedirect, args=(1,sugesstion,respuestas,)))
        elif(question == 456):
            question4 = request.POST['question4']
            question5 = request.POST['question5']
            ...
            question_new = engine.question
            sugesstion = engine.sugesstion
            respuestas = 'Según sus respuestas a la Pregunta 1 : '+question4+', Pregunta 2: '+question5+', y Pregunta 3:'+question6
            return HttpResponseRedirect(reverse(urlRedirect, args=(1,sugesstion,respuestas,)))
        ...
        return HttpResponseRedirect(reverse("questionsRules:loteryrules", args=(question.id,)))
    
def Prueba(request, question_id, sugesstion,respuestas):
    question = 1
    engine = integrateHanlingLottery()
    engine.reset()
    engine.declare(RandomList(questionId=1))
    ...
    return render(request, "questionsRules/Prueba.html", {
        "latest_question_list": sugesstion.replace("  ","").split(sep=';'),
        "question": question,
